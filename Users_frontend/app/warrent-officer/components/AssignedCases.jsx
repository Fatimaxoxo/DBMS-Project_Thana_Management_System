              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold text-gray-800">
                      {caseItem.case_number ||
                        caseItem.summary ||
                        `কেস #${caseItem.case_id}`}
                    </h3>
                    <div className="flex space-x-2">
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${getPriorityColor(
                          caseItem.priority || "মাধ্যম"
                        )}`}
                      >
                        {caseItem.priority || "মাধ্যম"}
                      </span>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2 text-sm">
                    <div>
                      <span className="text-gray-600">কেস নম্বর:</span>
                    ...
                    <div>
                      <span className="text-gray-600">অভিযোগ ID:</span>
                      <span className="font-medium ml-2">
                        {caseItem.complaint_id || "N/A"}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-600">থানা ID:</span>
                      <span className="font-medium ml-2">
                        {caseItem.thana_id || "N/A"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mt-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {caseItem.progress_percentage || 0}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${caseItem.progress_percentage || 0}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col space-y-2 ml-4">
                  ...
                  <button
                    onClick={() =>
                      onUpdateProgress(caseItem.case_id, {
                        progress: (caseItem.progress_percentage || 0) + 10,
                      })
                    }
