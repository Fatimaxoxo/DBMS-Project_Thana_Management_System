...
export default function WarrantNavbar({
  ...
  return (
    <nav className="bg-gradient-to-r from-indigo-800 to-purple-900 text-white px-6 py-4 shadow-lg">
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <div className="bg-white text-indigo-800 rounded-full w-12 h-12 flex items-center justify-center font-bold text-lg">
            {officer.name
              .split(" ")
              .map((n) => n[0])
              .join("")}
          ...
          <div>
            <h1 className="text-xl font-bold">ওয়ারেন্ট অফিসার ড্যাশবোর্ড</h1>
            <p className="text-sm text-indigo-200">{officer.thana}</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-6">
          <div className="relative">
            <button
              className="relative p-2 text-indigo-200 hover:text-white transition"
